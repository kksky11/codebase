export const en = [
    {"label": "My Account", "icon": "myAccount", "link": "my-account/dashboard", "isActive": true
        ...
        "dropdown": [
            ...
            { "label": "Personal Loan", "icon": "", "link": "personal-loan?utm_source=MA_MyAccount&lang=en", "isActive": true },
            { "label": "Business Loan", "icon": "", "link": "business-loan/?utm_source=MA_MyAccount", "isActive": true },
        ...
        "dropdown": [
            { "label": "FAQs", "icon": "", "link": "/", "isActive": true },
