...
const TopQuestions = dynamic(() => import('@components/views/faqs/TopQuestions'), { loading: () => '', });
const UnsubscribeArticle = dynamic(() => import('@components/views/faqs/UnsubscribeArticle'), { loading: () => '', });
