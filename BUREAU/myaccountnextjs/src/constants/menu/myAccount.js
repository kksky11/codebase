export const en = [
    {"label": "My Account", "icon": "myAccount", "link": "/my-account/dashboard", "isActive": true
    },{
        "label": "Products", "icon": "product", "link": "dropdown", "isActive": true,
        "dropdown": [
            { "label": "Credit Report", "icon": "",         "link": "/bureau/report-analysis", "isActive": true },
        ...
        "dropdown": [
            { "label": "FAQs", "icon": "", "link": "/support/faqs", "isActive": true },
            { "label": "Submit a Query", "icon": "", "link": "/support/query", "isActive": true },
            { "label": "Contact Us", "icon": "", "link": "/support/contact", "isActive": true }
        ]
